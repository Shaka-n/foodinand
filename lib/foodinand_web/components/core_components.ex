defmodule FoodinandWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FoodinandWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FoodinandWeb.Gettext, "errors", msg, opts)
    end
  end
